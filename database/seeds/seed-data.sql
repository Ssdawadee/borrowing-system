...
('ไมโครโฟน', 'เครื่องเสียง', 'ชุดไมโครโฟนไร้สายสำหรับกิจกรรมบนเวที', 8, 8, 'https://images.unsplash.com/photo-1516280440614-37939bbacd81?auto=format&fit=crop&w=800&q=80', 'NORMAL'),
...
('แล็ปท็อป', 'คอมพิวเตอร์', 'แล็ปท็อปสำหรับนำเสนอผลงานและลงทะเบียนกิจกรรม', 4, 4, 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=crop&w=800&q=80', 'NORMAL'),
('ลำโพง', 'เครื่องเสียง', 'ลำโพงสำหรับกิจกรรมกลางแจ้งและงานประชาสัมพันธ์', 4, 4, 'https://images.unsplash.com/photo-1545454675-3531b543be5d?auto=format&fit=crop&w=800&q=80', 'NORMAL'),
